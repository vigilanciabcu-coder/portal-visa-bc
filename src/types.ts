...
export const PRESET_PAGINAS = {
  FISCAL: ['processos_lab', 'alvara_visa', 'fiscalizacao', 'agenda', 'cnae', 'telefone', '1doc', 'epub', 'ahgo', 'mail', 'geoo', 'cnpj', 'leis', 'mapa', 'pref'],
  ...
  ADMINISTRATIVO: ['pasta_visa', 'alvara_visa', 'processos_lab', 'agenda', 'telefone', '1doc', 'epub', 'ahgo', 'rhwb', 'mail', 'domm', 'cnpj', 'alva', 'debi', 'leis', 'pref'],
...
export interface PortalButton {
  ...
  img: string;
  acao: 'link' | 'view';
  view?: 'home' | 'feiras' | 'agenda' | 'master' | 'fiscalizacao' | 'processos' | 'processos_lab' | 'laboratorio' | 'cidadao' | 'portal_contador' | 'cnae' | 'telefone' | 'pasta_visa' | 'alvara_visa';
  badgetext?: string;
