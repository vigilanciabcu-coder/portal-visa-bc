import { UserProfile, EscalaItem, FeiranteItem, RecadoMural, ChatMessage, FiscalizacaoItem, ProcessoItem, AmostraLaboratorioItem, PontoColetaLaboratorio, ServidorColetaLaboratorio, LaboratorialistaResponsavel, ContabilidadeProfile, CidadaoProfile, ContribuinteProfile } from '../types';
...
export const INITIAL_USERS: UserProfile[] = [
  ...
  {
    id: 'u5',
    email: 'juliana.costa@bc.sc.gov.br',
    nome_completo: 'Dra. Juliana Costa',
    data_nascimento: '1988-06-14',
    cargo: 'FARMACÊUTICO/BIOQUÍMICO',
    setor: 'VIGILÂNCIA SANITÁRIA',
    nivel_acesso: 'VISA (SAÚDE)',
    matricula: 'FIS-4105',
    senha: '123456'
  },
  {
    id: 'u6',
    email: 'marcos.toledo@bc.sc.gov.br',
    nome_completo: 'Marcos Vinícius Toledo',
    data_nascimento: '1986-09-22',
    cargo: 'FISCAL DE VIGILÂNCIA SANITÁRIA',
    setor: 'VIGILÂNCIA SANITÁRIA',
    nivel_acesso: 'VISA (ALIMENTOS)',
    matricula: 'FIS-4112',
    senha: '123456'
  },
  {
    id: 'u7',
    email: 'fernanda.eng@bc.sc.gov.br',
    nome_completo: 'Eng. Fernanda Albuquerque',
...
export const INITIAL_CONTABILIDADES: ContabilidadeProfile[] = [
  {
    ...
    crc: 'CRC/SC-012345/O',
    responsavel: 'Carlos Alberto Contabilista',
...
export const INITIAL_CONTRIBUINTES: ContribuinteProfile[] = [
  {
    id: 'contrib-1',
    tipo_pessoa: 'PJ',
    categoria: 'EMPRESARIO',
    cnpj_cpf: '12.345.678/0001-90',
    razao_social: 'RESTAURANTE E PIZZARIA ATLÂNTICO LTDA',
    nome_fantasia: 'Pizzaria Atlântico BC',
    responsavel: 'Marcos Roberto da Silva',
    email: 'contato@pizzariaatlantico.com.br',
    telefone: '(47) 3361-9090',
    ramo_atividade: '56.11-2-01 - Restaurantes e similares',
    bairro: 'Centro',
    endereco: 'Av. Atlântica, 2400',
    senha: '123456',
    data_cadastro: '2026-01-20'
  },
  {
    id: 'contrib-2',
    tipo_pessoa: 'PF',
    ...
    razao_social: 'JOÃO BATISTA DOS SANTOS',
    nome_fantasia: 'Barraca do Pastel & Caldo de Cana',
    responsavel: 'João Batista dos Santos',
    email: 'joao.pastel@gmail.com',
    telefone: '(47) 98888-1234',
    ramo_atividade: 'Feirante - Feira da Cultura e Feira da Orla',
    bairro: 'Centro',
    endereco: 'Praça da Bíblia, Box 14',
    senha: '123456',
    data_cadastro: '2026-01-15'
  }
];
...
export const INITIAL_CIDADAOS: CidadaoProfile[] = [
  {
    id: 'cid-1',
    nome_completo: 'Cidadão Exemplo Balneário',
    cpf: '123.456.789-00',
