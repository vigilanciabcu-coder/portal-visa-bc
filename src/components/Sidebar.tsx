...
import { ShieldCheck, Calendar, Microscope, Crown, User, Building2, Search, FileText, FileSpreadsheet, PhoneCall, FolderArchive, FileSignature, Users } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const renderIcon = (b: PortalButton) => {
    if (b.view === 'demandas_fiscal' || b.id === 'demandas_fiscal' || b.img === 'demandas-fiscal') {
      return <FileSignature className="w-6 h-6 text-blue-400" />;
    }
