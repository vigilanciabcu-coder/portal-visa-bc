...
export const MasterView: React.FC<MasterViewProps> = ({
  ...
  const handlePostBirthdayMural = (u: UserProfile) => {
    ...
    const bdayRecado: RecadoMural = {
      ...
      conteudo: `Desejamos um excelente aniversário e muitas felicidades ao nosso servidor(a) ${u.nome_completo} (${u.cargo})! Homenagem da Divisão e Equipe DVIS/BC. 🎉🎈`,
      prioridade: 'ALERTA',
      autor: currentUser ? currentUser.nome_completo : 'DIVISÃO DVIS',
      cargo: 'DIRETOR',
      data: todayStr
    };
