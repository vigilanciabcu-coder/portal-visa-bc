...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  const visibleButtons = buttons.filter((b) => {
    // Master tem acesso total a 100% de todos os botões do sistema
    ...
    if (b.id === 'proc' || b.id === 'tproc' || b.id === 'setores' || b.view === 'processos') {
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Upper Content: App Grid and Right Column */}
            ...
            {visibleButtons.map((b) => (
              <div
                ...
                className={`card-app relative ${
                  b.view === 'demandas_fiscal' || b.id === 'demandas_fiscal'
                    ? 'border-2 border-blue-500 dark:border-blue-500 bg-blue-50/50 dark:bg-blue-950/20'
                    : b.view === 'demandas_diretor' || b.id === 'demandas_diretor'
                    ? 'border-2 border-purple-500 dark:border-purple-500 bg-purple-50/50 dark:bg-purple-950/20'
                    : b.view === 'alvara_visa' || b.id === 'alvara_visa'
                    ...
                    : b.id === 'tproc' || b.id === 'tproc_lab' || b.id === 'setores'
          ...
          {userType === 'CIDADAO' ? (
            ...
            <div className="space-y-4 text-left">
              ...
              <div className="bg-white dark:bg-slate-800 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
                ...
                <ul className="space-y-2 text-[11px] text-slate-600 dark:text-slate-300">
                  ...
                  >
                    <ChevronRight className="w-3.5 h-3.5 text-emerald-500" />
                    <span>Portal Tributário e Débitos</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4 text-left">
              ...
              <div className="bg-slate-50 dark:bg-slate-800/60 p-5 rounded-2xl border border-slate-200 dark:border-slate-700">
                <h4 className="text-xs font-black uppercase text-slate-800 dark:text-white flex items-center gap-1.5 mb-2.5">
                  <FileText className="w-4 h-4 text-indigo-500" /> Guia Rápido do Contabilista
                </h4>
